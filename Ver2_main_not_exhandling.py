...
def main(**originalkwargs):
    ...
    for i in range(len(param_set)):
        ...
        for k in range(iterNum):
            ...
            if k == 0:
                ...
                z, z_lr, z_hl, z_rr, r_dsp_array, stream_cp, l_erosion_rate, r_erosion_rate = Cl.do_computing(x, init_z, k)
    ...
    #                     from IPython.core.debugger import Pdb; Pdb().set_trace()
                ...
                z, z_lr, z_hl, z_rr, r_dsp_array, stream_cp, l_erosion_rate, r_erosion_rate = Cl.do_computing(x, z_next, k)
                #print("zlr_last: \n{}".format(z_lr[-1]))
                r_dsp = 0
                h_dsp = 0
                if len(r_dsp_array) != 0:
