...
Ver3_stream_capture.py Ver3_main_not_exhandling.pyと組み合わせて使用する。
"""

import Ver3_main_not_exhandling as m
...
if __name__ == '__main__':
    ...
    param_dict_1 = {
        ...
        "iterNum": 700, #総計算時間を決める数。具体的にはnamx*iterNumだけ計算する。メモリの都合上、このように総計算時間を分割した。
        ...
        "ka" : 8.6, #逆ハックの法則係数
        "a" : 1.6, #逆ハックの法則における指数：流域面積と河川長の関係を決定する 
        ...
        "only_one_param" : "-",
        "xzExfile" : r"G:\miyata\Simulation Model\result\NY1ver2.xlsx",
        "place" : ["NY1"],
        "BoundaryHDFfile" : r"G:\miyata\Simulation Model\result\Truk\tiltingUplift", # 境界条件の標高値HDFファイルがあるディレクトリのパス
        "LeftTrunk" : "namura",
        "RightTrunk" : "yasuda"
    }
