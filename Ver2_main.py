...
import Ver2_stream_capture as sc
    ...
    for i in range(len(param_set)):
        ...
        try:
            for k in range(iterNum):
                ...
                if k == 0:
                    try:
                        ...
                        z, z_lr, z_hl, z_rr, r_dsp_array, stream_cp, l_erosion_rate, r_erosion_rate = Cl.do_computing(x, init_z, k, uplift=uplift)
            #                     from IPython.core.debugger import Pdb; Pdb().set_trace()
                    ...
                    try:
                        z, z_lr, z_hl, z_rr, r_dsp_array, stream_cp, l_erosion_rate, r_erosion_rate = Cl.do_computing(x, z_next, k, uplift=uplift)
                        print("zlr: \n{}".format(z_lr))
                        r_dsp = 0
                        h_dsp = 0
                        if len(r_dsp_array) != 0:
